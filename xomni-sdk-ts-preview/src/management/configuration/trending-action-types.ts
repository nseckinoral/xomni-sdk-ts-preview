...
module Xomni.Management.Configuration.TrendingActionTypes {
    export class TrendingActionTypesClient extends BaseClient {
        ...
        put(actionTypes: Models.Management.Configuration.TrendingActionTypeValue[], success: (result: Models.Management.Configuration.TrendingActionTypeValue[]) => void, error: (error: any) => void) {
            this.httpProvider.put(this.uri, actionTypes, success, error);
        }

        get(success: (result: Models.Management.Configuration.TrendingActionTypeValue[]) => void, error: (error: any) => void) {
